...
# print "Shape 1", Boltzmann_Steps.shape
# print "Shape 2", Boltzmann_Rewards.shape
...
# Dropout_Greedy_Steps = np.load('Dropout_Greedy_Train_Steps_Episodes.npy')
# Dropout_Greedy_Rewards = np.load('Dropout_Greedy_Train_Rewards_Episodes.npy')



# Dropout_Epsilon_Greedy_Steps = np.load('Dropout_Epsilon_Train_Steps_Episodes.npy')
# Dropout_Epsilon_Greedy_Rewards = np.load('Dropout_Epsilon_Train_Rewards_Episodes.npy')




Dropout_Boltzmann_Steps = np.load('Dropout_Boltzmann_Train_Steps_Episodes.npy')
Dropout_Boltzmann_Rewards = np.load('Dropout_Boltzmann_Train_Rewards_Episodes.npy')
print "Shape 1", Dropout_Boltzmann_Steps.shape
print "Shape 2", Dropout_Boltzmann_Rewards.shape



def comparing_exploration(stats1, stats2,  stats3, eps,  smoothing_window=100, noshow=False):
...
def main():
    single_runs(Dropout_Boltzmann_Steps, eps)
